...
function Business() {
    ...
    useEffect(() => {
        const fetchPosts = async () => {
            try {
                const response = await axios.get('http://127.0.0.1:8000/posts/?category=Business');
                        ...
                        <div className={`single_post post_1 ${index === 0 ? 'feature_post' : ''}`}>
                            <div className="single_post_img">
                                <img 
                                    ...
                                    alt={post.title} 
                                    style={{ height: index === 0 ? '408px' : '327px', width: index === 0 ? '621px' : '540px' }} 
                                />
                            </div>
